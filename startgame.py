...
class game:
    ...
    def next_turn(self, now_turn):
        if now_turn == 0:
            user_text = self.text_format("Eu", "Berlin Sans FB", 30, (0, 0, 0))
    ...
    def select_player(self, now_turn):
        if now_turn == 0:
            user_text = self.text_format("EU", "Berlin Sans FB", 30, (255, 242, 0))
            self.screen.blit(user_text, (165, 420))
        elif now_turn == 1:
    ...
    def restart(self):
        ...
        if len(self.user_group) == 0:
            win.play()
            close_text = self.text_format("VENCEU!", "Berlin Sans FB", 80, (255, 51, 0))
            press_text = self.text_format(
                "Pressione ESPAÇO",
                "Berlin Sans FB",
                35,
                (255, 51, 0),
            ...
            lose.play()
            close_text = self.text_format("PERDEU!", "Berlin Sans FB", 80, (255, 51, 0))
            press_text = self.text_format(
                "Pressione ESPAÇO",
                "Berlin Sans FB",
                35,
